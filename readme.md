# 🎮 Valorant Players Hub

<div align="center">

![Valorant Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,14,18,20,24&height=200&section=header&text=Valorant%20Players%20Hub&fontSize=50&fontColor=fff&animation=fadeIn&fontAlignY=35)

### 🔥 Descubra os Melhores Jogadores Profissionais de Valorant

[![Made with Love](https://img.shields.io/badge/Made%20with-❤️-red?style=for-the-badge)](https://github.com/gabrielnfujii)
[![Alura](https://img.shields.io/badge/Imersão-Alura-blue?style=for-the-badge&logo=alura&logoColor=white)](https://www.alura.com.br/)
[![Google Gemini](https://img.shields.io/badge/Google-Gemini-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://gemini.google.com/)

![GitHub repo size](https://img.shields.io/github/repo-size/gabrielnfujii/imers-o_dev_Alura?style=for-the-badge&logo=github)
![GitHub language count](https://img.shields.io/github/languages/count/gabrielnfujii/imers-o_dev_Alura?style=for-the-badge&logo=github)
...
O **Valorant Players Hub** é uma aplicação web moderna e responsiva desenvolvida durante a **Imersão Dev da Alura com Google Gemini**. 

Este projeto permite aos fãs de Valorant pesquisar, filtrar e conhecer mais sobre os principais jogadores profissionais do cenário competitivo mundial.

### 💡 Motivação

Como fã de esports e entusiasta de desenvolvimento web, criei esta plataforma para combinar duas paixões: **programação** e **Valorant**!
...
<img src="https://media.giphy.com/media/3oriNYQX2lC6dfW2Ji/giphy.gif" width="200">
...
| 🏆 Jogador | 🏢 Time | 🌎 Região | ⭐ Rating | 🎯 Role |
|-----------|---------|----------|----------|---------|
| **Aspas** | LOUD | 🇧🇷 BR | 9.8 | Duelist |
| **TenZ** | Sentinels | 🇺🇸 NA | 9.5 | Duelist |
| **Demon1** | Evil Geniuses | 🇺🇸 NA | 9.6 | Duelist |
| **Saadhak** | LOUD | 🇦🇷 LATAM | 9.3 | IGL |
| **Sacy** | Sentinels | 🇧🇷 BR | 9.1 | Initiator |
| **Less** | LOUD | 🇧🇷 BR | 9.2 | Sentinel |
| **jawgemo** | Evil Geniuses | 🇺🇸 NA | 8.9 | Duelist |
| **Derrek** | Evil Geniuses | 🇺🇸 NA | 8.7 | Initiator |
...
```mermaid
graph LR
    A[v1.0 - MVP] --> B[v2.0 - Filtros & Design]
    B --> C[v3.0 - Favoritos]
    C --> D[v4.0 - API Integration]
    D --> E[v5.0 - Comparação]
...
[![Discussions](https://img.shields.io/badge/Discussions-Participar-blue?style=for-the-badge&logo=github)](https://github.com/gabrielnfujii/imers-o_dev_Alura/discussions)
